...
<html class="no-js" lang="en">
    ...
    <body>
                            ...
                            <div class="col-lg-6">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <span class="nav-link active" id="popular1-tab" data-bs-toggle="tab" data-bs-target="#popular1"
                                              role="tab" aria-controls="popular1" aria-selected="true">Popular</span>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <span class="nav-link" id="bastsaller1-tab" data-bs-toggle="tab" data-bs-target="#bastsaller1"
                                              role="tab" aria-controls="bastsaller1" aria-selected="false">Best Saller</span>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <span class="nav-link" id="featured1-tab" data-bs-toggle="tab" data-bs-target="#featured1" role="tab"
                                              aria-controls="featured1" aria-selected="false">Featured</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="tab-content product-tab-full" id="myTabContent">
                            <div class="tab-pane product-tab-item fade show active" id="popular1" role="tabpanel"
                            ...
                            <div class="tab-pane product-tab-item fade" id="bastsaller1" role="tabpanel"
                                 aria-labelledby="bastsaller1-tab">
                                <div class="product-tab-slider-full owl-carousel">
        ...
        <div class="sales-banner pt-50 pb-50" style="background-image: url('./resources/img/sale-bnr-large.jpg');">
            <div class="container">
                    ...
                    <div class="col-lg-3">
                        <div class="deal-popular-product">
                            ...
                            <div class="deal-popular-product-all">
                                ...
                                <!-- Singel -->
                                <div class="deal-popular-product-single">
                                    <img src="./resources/img/product/2.jpg" alt="product">
                                    <div class="content">
                                        <h5><a href="#">Funda Para Ebook 7" 128GB full HD</a></h5>
                                        <div class="pricing">
                                            <span>$200 <del>$210</del></span>
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            <div class="deal-product-slider-single-content">
                                                ...
                                                <div class="right">
                                                    ...
                                                    <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate perferendis consequuntur
                                                        illo aliquid nihil ad neque, debitis praesentium libero ullam asperiores. Lorem ipsum dolor
