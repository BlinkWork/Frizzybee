                ...
                <form action="#">
                  ...
                  <div class="single-input-item">
                    ...
                    <div class="form-check">
                      <label class="inline"><input class="form-check-input" type="checkbox"><span class="input"></span>Create an account?</label>
                    </div>
                  </div>
                  <div class="single-input-item">
                    <div class="form-check">
                      <label class="inline"><input class="form-check-input" type="checkbox"><span class="input"></span>Ship to a different address?</label>
                    </div>
                  </div>
                  <div class="single-input-item">
              ...
              <div class="order-summary-content">
                <div class="order-summary-table table-responsive text-center">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        <td><a href="#">Suscipit Vestibulum <strong> × 1</strong></a>
                        </td>
                        <td>$165.00</td>
                      </tr>
                      <tr>
                        <td><a href="#">Ami Vestibulum suscipit <strong> × 4</strong></a>
                        </td>
                        <td>$165.00</td>
                      </tr>
                      <tr>
                        <td><a href="#">Vestibulum suscipit <strong> × 2</strong></a>
                        </td>
                        <td>$165.00</td>
                      </tr>
                    </tbody>
