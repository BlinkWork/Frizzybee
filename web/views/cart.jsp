  ...
  <body class="sub_page">
    ...
    <section id="cart--section">
      <table id="cart">
        ...
        <tbody>
          <tr>
            <td class="image"><img src="product1.jpg" alt="Sản phẩm 1"></td>
            <td class="name">Sản phẩm 1</td>
            <td class="quantity"><input type="number" value="1"></td>
            <td class="price">100.000 đ</td>
            <td class="total">100.000 đ</td>
          </tr>
          <tr>
            <td class="image"><img src="product2.jpg" alt="Sản phẩm 2"></td>
            <td class="name">Sản phẩm 2</td>
            <td class="quantity"><input type="number" value="2"></td>
            <td class="price">200.000 đ</td>
            <td class="total">400.000 đ</td>
          </tr>
        </tbody>
      </table>
      <div class="total">
        <p>Tổng cộng: <span>500.000 đ</span></p>
        <a href="#" id="checkout-btn">Thanh toán</a>
      </div>
    </section>
    <!-- end product section -->
    <!-- footer section -->
