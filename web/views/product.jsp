  ...
  <body class="sub_page">
    ...
    <section class="product_section layout_padding">
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-2 col-md-2 col-lg-3" style="padding-top: 30px; font-size: 15px">
            <div class="filter">
              <div class="category">
                <h3>Category</h3>
                <label for="electronics"><input type="checkbox" id="electronics" name="category" value="electronics"> Electronics</label>
                <label for="clothing"><input type="checkbox" id="clothing" name="category" value="clothing"> Clothing</label>
                <label for="books"><input type="checkbox" id="books" name="category" value="books"> Books</label>
              </div>
              <div class="department">
                <h3>Department</h3>
                <label for="computers"><input type="checkbox" id="computers" name="department" value="computers"> Computers</label>
                <label for="mobiles"><input type="checkbox" id="mobiles" name="department" value="mobiles"> Mobiles</label>
                <label for="mens"><input type="checkbox" id="mens" name="department" value="mens"> Mens</label>
                <label for="womens"><input type="checkbox" id="womens" name="department" value="womens"> Womens</label>
                <label for="fiction"><input type="checkbox" id="fiction" name="department" value="fiction"> Fiction</label>
                <label for="non-fiction"><input type="checkbox" id="non-fiction" name="department" value="non-fiction"> Non-fiction</label>
              </div>
              <div class="tag">
                <h3>Tag</h3>
                <label for="best-seller"><input type="checkbox" id="best-seller" name="tag" value="best-seller"> Best Seller</label>
