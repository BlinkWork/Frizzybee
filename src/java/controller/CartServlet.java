...
public class CartServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    String temp = request.getParameter("remove");
    if (temp != null) {
    ...
    if (cartItems != null) {
      ...
      for (Cart cartItem : listCartId) {
        ...
        String dataItem = "<tr>\n"
                ...
                + "  <td class='pro-remove'><a href='./cart?remove=" + p.getProductID() + "' class='removeProduct' id='" + p.getProductID() + "'><i class='fas fa-times' ></i></a></td>\n"
                + "</tr>";
        data += dataItem + "\n";
      }
    } else {
