...
<html  class="no-js" lang="en">
  <head>
    ...
    <title>BulkShop - Electronics Shop HTML Template | Contact</title>
  ...
  <body>
    ...
    <!-- Start Contact Form -->
    <section class="contact-form pt-70 pb-70">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="contact-form">
              ...
              <div class="form">
                <form action="#">
                  <div class="row">
                    <div class="col-md-6">
                      <input type="text" name="naem" placeholder="Name">
                    </div>
                    <div class="col-md-6">
          ...
          <div class="col-lg-6">
            <div class="contact-info">
              ...
              <ul>
                <li><i class="fas fa-map-marker-alt"></i> Address : No 40 Baria Sreet 133/2 NewYork City</li>
                <li><i class="far fa-envelope"></i>  info@yourdomain.com</li>
                <li><i class="fas fa-mobile-alt"></i>  +88013245657</li>
              </ul>
              <p> Mirum est notare quam littera gothica, quam nunc putamus parum claram anteposuerit litterarum formas human. Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim veniamquis Lorem ipsum dolor sit amet, consectetuipisicing elit.Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim veniamquis </p>
            </div>
          </div>
        </div>
      </div>
