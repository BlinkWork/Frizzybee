...
<html>
    ...
    <body>
        ...
        <form action="editBrand" method="POST">
            <% for (String col : cols) {
            if (col.equals("brand_id")) { %>
            <div class="form-group">
                <label><%=col%></label>
                <input type="text" name="<%=col%>" value="<%=brand.getBrandID()%>" readonly />
            </div>
            <% } else { %>
            <div class="form-group">
                <label><%=col%></label>
                <input type="text" name="<%=col%>" value="<%= b.getBrandInformation(Integer.toString(brand.getBrandID()), col) %>"/>
            </div>
            <% } }%>
